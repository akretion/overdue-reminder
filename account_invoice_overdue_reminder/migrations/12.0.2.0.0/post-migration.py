...
def migrate(cr, version):
    ...
    with api.Environment.manage():
        ...
        # same 2 reminders for the same customer the
        # same day
        # So, in order to create overdue.reminder.action, we
        # read account.invoice.overdue.reminder and we group by date
        # fields : commercial_partner_id, partner_id,
        # date, user_id, reminder_type, result_id, result_notes,
        # mail_id, company_id
        cr.execute(
            """
